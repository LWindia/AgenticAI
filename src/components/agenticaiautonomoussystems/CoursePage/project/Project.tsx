...
export default function ProgramsSection() {
  markRender("AgenticAIAutonomousSystemsProjectSection");
...
const tracks = [
  ...
  <div className="max-w-5xl mx-auto">
    <div className="text-center mb-12">
      ...
      <p className="text-lg">Master AI by working on industry-grade projects—building, innovating, and solving challenges to prepare for the fast-moving industry.</p>
    </div>
    {safariFallback ? (
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
        {tracks.slice(0, 12).map((track, index) => (
          <Card
            key={index}
            className="flex min-h-[290px] flex-col overflow-hidden rounded-lg border border-gray-800 bg-black"
          >
