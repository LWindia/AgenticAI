    ...
    <div className="max-w-5xl mx-auto">
      <div className="text-center mb-10">
        ...
        <div className="flex items-center justify-center gap-3 mb-4">
          ...
          <span className="text-xs font-bold uppercase tracking-widest text-purple-400">Hands-On Projects</span>
          <div className="h-px w-12 bg-gradient-to-l from-transparent to-purple-500" />
        </div>

        <h2 className="text-sm uppercase tracking-wider mb-2 text-gray-400">AI Warrior Projects:</h2>
        ...
        <p className="text-lg text-gray-300 max-w-2xl mx-auto mb-2">
          Master AI by working on industry-grade projects—building, innovating, and solving challenges to prepare for the fast-moving world.
        </p>

        {/* Trust line */}
        <p className="text-xs text-purple-400 font-semibold mb-5">
          ✦ Portfolio-ready projects · Reviewed by industry experts
        </p>
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mb-6">
          {[
            ...
            { icon: '⏱️', label: 'Hours of Building' },
            { icon: '📊', label: 'Real Datasets' },
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {tracks.map((track, index) => {
          const difficulties = ['Beginner', 'Intermediate', 'Advanced', 'Intermediate'];
          const diffColors = ['text-green-400 bg-green-400/10 border-green-400/30', 'text-yellow-400 bg-yellow-400/10 border-yellow-400/30', 'text-red-400 bg-red-400/10 border-red-400/30', 'text-yellow-400 bg-yellow-400/10 border-yellow-400/30'];
          const diff = difficulties[index % difficulties.length];
          const diffColor = diffColors[index % diffColors.length];
          return (
            <Card
              key={index}
            ...
            >
              <div className="flex-grow">
                <CardHeader className="pb-2">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className={`text-xs font-semibold border rounded-full px-2 py-0.5 ${diffColor}`}>{diff}</span>
                  </div>
              ...
              <CardFooter className="mt-auto">
                <Link href={track.link || "#"} className="w-full">
                  <Button variant="outline" className="w-full text-white font-bold hover:text-white bg-gradient-to-r from-purple-600 to-pink-600">
                    Know More
                  </Button>
                </Link>
              </CardFooter>
