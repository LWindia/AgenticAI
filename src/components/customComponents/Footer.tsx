...
const  Footer= () => {
  return (
    <div className="bg-black h-full flex items-center justify-center p-6 relative overflow-hidden">
      {/* Mobile: no large-area CSS blur (Safari/WebKit GPU pressure → tab crash looks like auto-reload). Desktop only. */}
      <div className="absolute inset-0 pointer-events-none lg:hidden bg-gradient-to-br from-purple-900/12 via-transparent to-blue-900/12" />
      <div className="absolute inset-0 pointer-events-none hidden lg:block bg-gradient-to-br from-purple-900/20 via-transparent to-blue-900/20 blur-3xl" />
