...
export const ProgramCard: React.FC<Capsule & { showBadgeImage?: boolean }> = ({
  ...
  const cardContent = (
    <div className="desktop-card-hover relative rounded-xl border border-white/10 bg-black hover:bg-zinc-900/80 overflow-hidden w-full cursor-pointer group">
          ...
          <div className="relative w-20 md:w-24 flex-shrink-0 flex items-center justify-center overflow-hidden">
            ...
            <picture>
              ...
              <img
                ...
                height={64}
                decoding="async"
                className="relative w-14 h-14 md:w-16 md:h-16 object-contain opacity-95 transition-transform duration-300 lg:group-hover:scale-110"
                loading="lazy"
              />
            </picture>
          </div>
